...
# %%
movies = pd.read_csv(r'E:\Movie-Recommendation-main-main\\movies.csv')
genome_scores = pd.read_csv(r'E:\Movie-Recommendation-main-main\\links.csv')
tags = pd.read_csv(r'E:\Movie-Recommendation-main-main\\tags.csv')
genome_tags = pd.read_csv(r'E:\Movie-Recommendation-main-main\\links.csv')
ratings = pd.read_csv(r'E:\Movie-Recommendation-main-main\\ratings.csv')
